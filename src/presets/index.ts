...
export function bassPatch(): Patch {
  ...
  const modules = [
    ...
    mod('osc1', 'osc', 540, 40, { wave: 'sawtooth', octave: -1, unison: 2, spread: 9 }),
    mod('osc2', 'osc', 540, 300, { wave: 'square', octave: -2, fine: -4 }, 'Sub'),
...
export function ambientPatch(): Patch {
  ...
  const modules = [
    ...
    mod('osc2', 'osc', 540, 560, { wave: 'triangle', octave: 0, unison: 2, spread: 10 }, 'Drone'),
